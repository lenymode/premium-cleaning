...
class ServicePageService
{
    ...
    private function make(string $title, string $excerpt, string $description, array $benefits, string $image): ServiceData
    {
        $slug = Str::slug($title);
