...
class ServicePageService
{
    ...
    private function fromModel(Service $service): ServiceData
    {
        return new ServiceData(
            ...
            $service->benefits ?: [],
            $service->faqs ?: [],
            $service->image ?: 'service/service_card_1.jpg',
