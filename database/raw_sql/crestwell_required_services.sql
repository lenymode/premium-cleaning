-- SQLite raw SQL for Crestwell Facilities required service set.
-- This does not run automatically. Run manually only after review.
-- It upserts the nine required services and deactivates old template services.
